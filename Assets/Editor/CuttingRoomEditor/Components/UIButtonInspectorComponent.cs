...
{
    public static class UIButtonInspectorComponent
    {
        public static VisualElement Render(ButtonUIController.UIButton uiButton, Action<ButtonUIController.UIButton> onEdit)
        {
