...
namespace CuttingRoom.Editor
{
	...
	{
		/// <summary>
		/// The layer narrative object represented by this node.
		/// </summary>
		private LayerNarrativeObject LayerNarrativeObject { get; set; } = null;
		...
		public LayerNarrativeObjectNode(LayerNarrativeObject layerNarrativeObject, NarrativeObject parentNarrativeObject) : base(layerNarrativeObject, parentNarrativeObject)
		{
            LayerNarrativeObject = layerNarrativeObject;

			StyleSheet = Resources.Load<StyleSheet>("LayerNarrativeObjectNode");
